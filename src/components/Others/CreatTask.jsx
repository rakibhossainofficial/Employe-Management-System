  ...
  return (
    ...
    <form className="flex w-full items-start justify-between mt-10 ">
      ...
      <div className='w-1/2'>
        ...
        <textarea className='w-full h-44 text-sm  rounded outline-none bg-transparent border-[1px] resize-none p-2' name="" id="" rows={10} cols={30}></textarea>
        <button className='bg-emerald-500  py-3 hover:bg-emerald-600 px-5 rounded text-sm mt-4 w-full focus:bg-emerald-600'>Creat Task</button>
      </div>
